...
extern unsigned long dhrystone_get_cycles(void);
#ifndef DHRY_HZ
#define DHRY_HZ 100000000UL
#endif
#ifndef DHRY_MIN_CYCLES
#define DHRY_MIN_CYCLES (DHRY_HZ / 100UL)
#endif
#define HZ DHRY_HZ
#define Too_Small_Time DHRY_MIN_CYCLES
#define CLOCK_TYPE "mmio_cycle"
#define Start_Timer() Begin_Time = (long)dhrystone_get_cycles()
#define Stop_Timer() End_Time = (long)dhrystone_get_cycles()
...
#define NUMBER_OF_RUNS		1800 /* Tuned for ~10ms at 100MHz on current core */
#endif
