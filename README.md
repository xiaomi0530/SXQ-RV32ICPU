...
***Version 4.26*** || CoreMark = **275.9 Iterations / sec** || **100MHz** || WNS **0.013ns** WHS **0.056ns** || LUT: **3625** || FF: **2741** || BRAM: **16** || DSP: **4** \
...
- 当前 benchmark 结果：`CoreMark = 275.879573 Iter/s`，`Dhrystone = 166000 Dhrystones/s`，`Embench-WikiSort = 122.58`。
...
| --- | --- | --- | --- | ---: | ---: | --- |
| CoreMark | `-march=rv32im -mabi=ilp32 -mstrict-align -O2` ; `ITERATIONS=1` | `275.879573 Iter/s` | `0.851` | `362458` | `308288` | `0.003625 s`, short run |
| Dhrystone | `-march=rv32im -mabi=ilp32 -mstrict-align -O2 -std=gnu89` ; `1800 runs` | `166000 Dhrystones/s` | `0.907` | `1081810` | `980993` | `6 us/run`, `0.945 DMIPS/MHz` |
| Embench-WikiSort | `-march=rv32im -mabi=ilp32 -mstrict-align -O2 -std=gnu11` ; `GLOBAL_SCALE_FACTOR=1` ; `WARMUP_HEAT=1` | `122.58` | `N/A` | `N/A` | `N/A` | `WS V=1` |

| Item | Value |
| --- | --- |
| FPGA Device | xc7a100tcsg324-1 |
| Clock | 100MHz |
| CoreMark | 275.879573 Iterations / sec |
| Dhrystone | 166000 Dhrystones / sec |
| Embench-WikiSort | 122.58 |
| DMIPS/MHz | 0.945 |
| WNS / WHS | 0.013ns / 0.056ns |
| LUT / FF / BRAM / DSP | 3625 / 2741 / 16 / 4 |
