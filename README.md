...
***Version 4.26*** || CoreMark = **275.9 Iterations / sec** || **100MHz** || WNS **0.002ns** WHS **0.028ns** || LUT: **3601** || FF: **2727** || BRAM: **16** || DSP: **4** \
...
- 当前正式 benchmark 结果：`CoreMark = 275.921923 Iter/s`，`Dhrystone = 166000 Dhrystones/s`，`Embench-WikiSort = 121.97`。
...
| Clock | 100MHz |
| CoreMark | 275.921923 Iterations / sec |
| Dhrystone | 166000 Dhrystones / sec |
| Embench-WikiSort | 121.97 |
| DMIPS/MHz | 0.945 |
| WNS / WHS | 0.017ns / 0.027ns |
| LUT / FF / BRAM / DSP | 3674 / 2810 / 16 / 4 |
