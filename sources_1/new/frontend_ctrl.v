...
module frontend_ctrl #(
    ...
    input  wire [IMEM_ADDR_BITS-1:0] if_jtb_target,
    ...
    output wire [IMEM_ADDR_BITS-1:0] if_pred_target_eff,
    ...
    output wire [IMEM_ADDR_BITS-1:0] if_pre_pred_target_eff,
    ...
    output wire [IMEM_ADDR_BITS-1:0] frontend_redirect_addr
);
    ...
    wire [IMEM_ADDR_BITS-1:0] if_pre_b_target_low;
    wire        if_pre_branch_pred_taken_eff;
    wire [31:0] if_pre_jal_imm;
    wire [IMEM_ADDR_BITS-1:0] if_pre_jal_target_low;
    wire        if_pre_jalr_pred_hit;
    wire [IMEM_ADDR_BITS-1:0] if_pre_jalr_pred_target_low;
    wire [IMEM_ADDR_BITS-1:0] if_pre_pred_target_low;
    ...
    assign if_pred_target_low    = if_is_jal ? if_jal_target_low
                                  ...
                                  : (if_is_b ? if_b_target_low : {IMEM_ADDR_BITS{1'b0}}));
    assign if_pred_target_eff    = if_pred_target_low;
    ...
    assign if_pre_b_target_low   = if_pre_instr_addr[IMEM_ADDR_BITS-1:0] + if_pre_b_imm[IMEM_ADDR_BITS-1:0];
    ...
    assign if_pre_jal_target_low = if_pre_instr_addr[IMEM_ADDR_BITS-1:0] + if_pre_jal_imm[IMEM_ADDR_BITS-1:0];
    ...
    assign if_pre_pred_target_low= if_pre_is_jal ? if_pre_jal_target_low
                                  ...
                                  : (if_pre_is_b ? if_pre_b_target_low : {IMEM_ADDR_BITS{1'b0}}));
