...
module imem(
    ...
    output reg  [31:0] if_pred_instr_o,
    output reg  [31:0] if_pred_instr_addr_o,
    ...
    always @(posedge clk) begin
        if(rst_n == `RST_ENABLE)begin
            ...
            if_pred_instr_o <= 32'b0;
            if_pred_instr_addr_o <= 32'b0;
        end else if(!pipeline_stall)begin
            if_instr_o <= imem[preif_pc_addr_i[14:2]];
            if_instr_addr_o <= preif_pc_addr_i;
            if_pred_instr_o <= imem[preif_pc_addr_i[14:2]];
            if_pred_instr_addr_o <= preif_pc_addr_i;
        end 
    end
